...
app.service('contentCategoryService',function($http){
    ...
    this.selectOrderByCondition=function(searchMap){
        return $http.post('../manager/selectOrderByCondition', searchMap);
    }

    this.updateByOrderId=function(id){
        return $http.post('../manager/updateByOrderId', id);
    }
